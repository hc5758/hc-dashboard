...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    else { setError('Password salah. Coba lagi.'); setLoading(false) }
  }
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-7">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="block text-[10px] font-bold text-white/40 mb-2 uppercase tracking-wider">Password</label>
        ...
        <p className="text-center text-white/20 text-xs mt-6">Akses hanya untuk tim HC 5758 Creative Lab</p>
      </div>
    </div>
  )
}
